...
class PicrossLoader(UserDict):
    ...
    def __missing__(self, name: str):
        filename = Path(__file__).parent / f"{name}.non"
        print(filename)
...
picross = PicrossLoader(
    {
        ...
        "cat": {
            "lines": "1,1 2,2 5 1,1,1 7 5,2 3,1 3,1 4,2 7",
            "columns": "1 6 2,6 8 2,6 6,2 1,1 1 1,2 4",
        },
        "horse": {
            "lines": "1 4 4,1 8 2,2 3,3 1,5 1,2,2,1 3,3 8",
            "columns": "2,3 2,2 5,3 8,1 1,2,1 1,1,1 1,3,1 7 3,2 2,2",
        },
        "house": {
            "lines": (
                "1 2,5 2,2,1,2 11 5,1,5 15 1,1 1,5,1 1,1,1,1,5,1 "
                "1,5,5,1 1,1,1,1,5,1 1,5,5,1 1,5,1 1,5,1 1,5,1"
            ),
            "columns": (
                "10 5 5,5 3,1,1,1 4,5 5,1,1,1 1,1,1,5 6 1,1,1,7 "
        ...
        "duck": {
            ...
            "columns": (
                "3 4 5 4 5 6 3,2,1 2,2,5 4,2,6 8,2,3 8,2,1,1 2,6,2,1 "
                "4,6 2,4 1"
            ),
        },
    }
